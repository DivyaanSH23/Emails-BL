...
console.log(validateEmail("abc@bridgelabz.co")); // ✅ true (Valid, no country code)
console.log(validateEmail("abc_123@bridgelabz.co.us")); // ✅ true (Valid)
console.log(validateEmail("abc+xyz@bridgelabz.co.uk")); // ✅ true (Valid)
console.log(validateEmail("abc-xyz@bridgelabz.co")); // ✅ true (Valid, without country code)
...
console.log(validateEmail("abc@bridgelabz.co.india")); // ❌ false (TLD should be only 2 letters)
